...
const FINAL_NOTE = `Paste a short final note, P.S., or inside joke here — this is what shows when she taps "Final Note".`;
...
document.getElementById('finalNoteText').textContent = FINAL_NOTE;
document.getElementById('finalNoteBtn').addEventListener('click', () => {
  document.getElementById('finalNoteModal').hidden = false;
});
document.getElementById('finalNoteCloseBtn').addEventListener('click', () => {
  document.getElementById('finalNoteModal').hidden = true;
  showScene('ending');
  fadeOutMusic();
});
