  ...
  <section class="scene" id="scene-5" data-scene="5">
    <div class="scene__inner">
      <div class="timer-card">
        <img class="timer-card__petal timer-card__petal--tl" src="assets/petal.svg" alt="" aria-hidden="true">
        <img class="timer-card__petal timer-card__petal--br" src="assets/petal.svg" alt="" aria-hidden="true">
        <p class="timer-card__eyebrow">every second with you &#9825;</p>
        ...
        <p class="timer-card__caption" id="timer-caption"></p>
      </div>
